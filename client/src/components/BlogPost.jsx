    ...
    return (
        <div className="blogpost bg-white">
            ...
            <div className="info px-5">
                ...
                <p className="inline-block text-lg py-2 border-b border-solid border-slate-300"><i>by <span className="text-[#2065b4] mx-1">{post?.author?.username}</span> on <span className='font-[monospace] ms-1'>{format(new Date(post.createdAt), 'MMMM i,yyyy p')}</span></i></p>
                {/* <hr className="my-4" /> */}
