        ...
        <div className="home">
            <div className="container w-full h-full flex justify-center items-center mx-auto text-center">
                ...
                <div className="links my-3">
                    <Link to="/signup" className="text-slate-700 bg-slate-50 px-3 py-1.5">Sign up</Link>
                    <Link to="/login" className="mx-2 text-slate-50 bg-[#e82222] px-3 py-1.5">Login</Link>
                </div>
                </div>
            </div>
        </div>
